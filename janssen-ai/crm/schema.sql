-- Janssen AI - CRM Database Schema
-- PostgreSQL-compatible SQL
-- Purpose: Backend database for AI customer service system

-- ============================================
-- TABLE: products
-- Purpose: Product catalog (mattresses, accessories)
-- Used by: Sales Agent
-- ============================================
...
-- ============================================
-- TABLE: prices
-- Purpose: Product pricing with versioning
-- Used by: Sales Agent
-- ============================================
CREATE TABLE prices (
    id SERIAL PRIMARY KEY,
...
-- Purpose: Regional delivery policies
...
-- Purpose: Product warranty terms
-- Used by: Warranty Agent
-- ============================================
...
-- ============================================
-- TABLE: leads
-- Purpose: Sales leads captured from conversations
-- Used by: Sales Agent
-- ============================================
CREATE TABLE leads (
    id SERIAL PRIMARY KEY,
...
-- ============================================
-- TABLE: complaints
-- Purpose: Customer complaints tracking
-- Used by: Complaint Agent
-- ============================================
